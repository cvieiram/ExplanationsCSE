...
tiff(file="../images/paper/Act2ClusterHeatS.tiff",width=1600,height=800)
multiplot(section1,section2,section3, section4, section5, cols=3)
dev.off()
...
stdClusters[stdClusters==4,]$stdClusters <- 10
# stdClusters$stdClusters <- 20   # This was only done to create sample plots
...
#multiplot(section1,section2,section3, section4, cols=2)
png(file="../images/temp/SampleSection1.png",width=800,height=400)
section1
dev.off()

png(file="../images/temp/SampleSection2.png",width=800,height=400)
section2
dev.off()

png(file="../images/temp/SampleSectionsClustered.png",width=1600,height=800)
multiplot(section1,section2,section3, section4, cols=2)
dev.off()
...
tiff(file="../images/paper/Act5ClusterHeat.tiff",width=1600,height=800)
multiplot(section1,section2,section3, section4, section5, cols=3)
dev.off()
...
tiff(file="../images/paper/Act11ClusterHeat.tiff",width=1600,height=1000)
multiplot(section1,section2,section3, section4, section5,section6, section7, cols=3)
dev.off()
...
# Creating the heat maps for each of the sections
section1 <- createHeatMapData(heatM[,c(1,2:22)], stdClusters, students, categoriesNew, 
                              '(a) Section 1 - Importing Libraries', 11,colorsLevels, groupLabels, 'legend',colorsCPMSE)
section2 <- createHeatMapData(heatM[,c(1,23:43)], stdClusters, students, categoriesNew, 
                              '(b) Section 2 - Setting up Problem Parameters', 11,colorsLevels, groupLabels, FALSE,colorsCPMSE)
section3 <- createHeatMapData(heatM[,c(1,44:64)], stdClusters, students, categoriesNew, 
                              '(c) Section 3 - Setting up Problem Parameters', 11,colorsLevels, groupLabels, FALSE,colorsCPMSE)
section4 <- createHeatMapData(heatM[,c(1,65:85)], stdClusters, students, categoriesNew, 
                              '(d) Section 4 - Setting up Supporting Variables', 11,colorsLevels, groupLabels, FALSE,colorsCPMSE)
section5 <- createHeatMapData(heatM[,c(1,86:106)], stdClusters, students, categoriesNew, 
                              '(e) Section 5 - Setting up Supporting Variables', 11,colorsLevels, groupLabels, FALSE,colorsCPMSE)
section6 <- createHeatMapData(heatM[,c(1,107:127)], stdClusters, students, categoriesNew, 
                              '(f) Section 6 - Validating Result',  11,colorsLevels,groupLabels,FALSE,colorsCPMSE)
