...
tiff(file="../images/paper/ToKCPMSE.tiff",width=1000,height=800)
pCPMSE
dev.off()
...
CK <- cbind('Declarative Knowledge',categoriesType[5:9,])
...
CKPlot <- plotCategoriesDist(CK, 'Declarative Knowledge')
...
tiff(file="../images/paper/ExplainerDistC.tiff",width=1000,height=800)
explainersPlot
dev.off()
